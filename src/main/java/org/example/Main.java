...
//        Console console = new Console(inputService, animalController, musicController, peopleController);
        ...
        InputService inputService = new InputService(new Scanner(System.in));
        AnimalController animalController = new AnimalController(new AnimalService(new AnimalRepositoryJDBC()), inputService);
        MusicController musicController = new MusicController(new MusicService(new MusicRepositoryJDBC()), inputService);
        PeopleController peopleController = new PeopleController(new PeopleService(new PeopleRepositoryJDBC()), inputService);
